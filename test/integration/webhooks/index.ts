export default {
	...
	'inbound-no-body': {
		...
		steps: [require('./inbound-no-body/01.json')],
	},
	...
	outbound: {
		...
		steps: [require('./outbound/01.json'), require('./outbound/02.json')],
	},
	...
	reminder: {
		...
		steps: [require('./reminder/01.json'), require('./reminder/02.json')],
	},
	'intercom-rule-reopen': {
		expected: require('./intercom-rule-reopen/expected.json'),
		steps: [require('./intercom-rule-reopen/01.json')],
	},
	'intercom-no-author': {
